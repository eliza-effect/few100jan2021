...
//const tipDiv = document.getElementById('tipButtons') as HTMLDivElement;
...
function updateTip() {
    const buttonClicked = this as HTMLButtonElement;
    tipPercentage = parseFloat(buttonClicked.dataset.tip);
    handleChange();
}
